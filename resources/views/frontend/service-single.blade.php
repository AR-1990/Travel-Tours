...
<!-- Mirrored from live.themewild.com/tavelo/service-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:52 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#650c0b030a25001d04081509004b060a08"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="9bf2f5fdf4dbfee3faf6ebf7feb5f8f4f6">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="service-sidebar">
                                <div class="widget category">
                                    ...
                                    <div class="category-list">
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Flight Deals</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Amazing Tour</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Support Cases</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>In Business</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Handpicked Hotels</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Private Guide</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Location Manager</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Best Travel Agent</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="service-details">
                                <div class="service-details-img mb-30">
                                    <img src="assets/img/service/single.html" alt="thumb">
                                </div>
                                <div class="service-details">
                                    <h3 class="mb-30">Amazing Tour</h3>
                                    <p class="mb-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-20">
                                            <img src="assets/img/service/01.html" alt="">
                                        </div>
                                        <div class="col-md-6 mb-20">
                                            <img src="assets/img/service/02.html" alt="">
                                        </div>
                                    </div>
                                    <p class="mb-20">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#b3daddd5dcf3d6cbd2dec3dfd69dd0dcde"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="dbb2b5bdb49bbea3bab6abb7bef5b8b4b6">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/service-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:55 GMT -->
</html>