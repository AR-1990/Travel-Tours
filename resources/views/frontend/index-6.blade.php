...
<!-- Mirrored from live.themewild.com/tavelo/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:01 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body class="home-5">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#056c6b636a45607d64687569602b666a68"><i
    ...
    <main class="main">
                        ...
                        <div class="col-lg-12 mx-auto">
                            <div class="hero-content text-center">
                                <div class="hero-content-wrapper">
                                    <h1 class="hero-title">Find Ideal Hotel In Best Price</h1>
                                    <p>Check Out The Best Deals On Over 5,000,000 Hotels Worldwide</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- room type -->
        <div class="room-type pb-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Room Type</span>
                            <h2 class="site-title">Our Popular Room Type</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="room-type-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                            <img src="assets/img/hotel/room/01.jpg" alt="">
                            <a href="#" class="theme-btn">Single Room<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="room-type-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".50s">
                            <img src="assets/img/hotel/room/02.jpg" alt="">
                            <a href="#" class="theme-btn">Double Room<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="room-type-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".75s">
                            <img src="assets/img/hotel/room/03.jpg" alt="">
                            <a href="#" class="theme-btn">Deluxe Room<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                <div class="destination-more-info">
                                    ...
                                    <span><i class="far fa-hotel"></i> 35 Hotel</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                ...
                                <span><i class="far fa-hotel"></i> 25 Hotel</span>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                ...
                                <span><i class="far fa-hotel"></i> 28 Hotel</span>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                ...
                                <span><i class="far fa-hotel"></i> 33 Hotel</span>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#3950575f56795c41585449555c175a5654"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="81e8efe7eec1e4f9e0ecf1ede4afe2eeec">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
