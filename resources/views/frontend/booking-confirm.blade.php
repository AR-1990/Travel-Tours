...
<!-- Mirrored from live.themewild.com/tavelo/booking-confirm.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:37 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Booking Confirm</h2>
                                ...
                                <div class="row g-5">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="booking-summary-list">
                                            <h6>Hotel Info</h6>
                                            <ul>
                                                <li>Hotel Name <span>Roltak Hotel & Resort</span></li>
                                                <li>Hotel Address <span>25/B Milford Road, New York</span></li>
                                                <li>Hotel Type <span>5 Star</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="booking-summary-list">
                                            ...
                                            <ul>
                                                <li>Cleaning, Airport Pickup</li>
                                                <li>Breakfast, Parking</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="booking-summary-list">
                                            ...
                                            <ul>
                                                ...
                                                <li>Email <span><a href="https://live.themewild.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="eb818485988485ab8e938a869b878ec5888486">info@wisetrust.com</a></span></li>
                                                <li>Phone <span>+2 134 562 458</span></li>
                                                <li>Address <span>25/B Milford Road, New York</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="booking-summary-list">
                                            ...
                                            <ul>
                                                ...
                                                <li class="fw-bold">Total Payment <span>$51,543.00</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
