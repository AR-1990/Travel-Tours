...
<!-- Mirrored from live.themewild.com/tavelo/hotel-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:15 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#3c55525a537c59445d514c5059125f5351"><i
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/05.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Hotel Full Width</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index-2.html">Home</a></li>
                    <li class="active">Hotel Full Width</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#ec85828a83ac89948d819c8089c28f8381"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="335a5d555c73564b525e435f561d505c5e">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
