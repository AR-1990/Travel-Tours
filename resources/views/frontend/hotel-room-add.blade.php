...
<!-- Mirrored from live.themewild.com/tavelo/hotel-room-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:21 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    ...
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#325b5c545d72574a535f425e571c515d5f"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="cca5a2aaa38ca9b4ada1bca0a9e2afa3a1">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Add Room</h2>
                    ...
                    <div class="col-lg-3">
                        <div class="user-profile-sidebar">
                            <div class="user-profile-sidebar-top">
                                ...
                                <h4>Antoni Jonson</h4>
                                <p><a href="https://live.themewild.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fc9693928f9392bc99849d918c9099d29f9391">info@wisetrust.com</a></p>
                            </div>
                    ...
                    <div class="col-lg-9">
                        <div class="user-profile-wrapper">
                            <div class="user-profile-card add-listing">
                                <h4 class="user-profile-card-title">Add Room</h4>
                                <div class="col-lg-12">
                                    <div class="add-listing-form">
                                        ...
                                        <form action="#">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select">
                                                            ...
                                                            <option value="5">Lake View</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                ...
                                                <h5 class="my-4">Your Room Information</h5>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select">
                                                            ...
                                                            <option value="2">Paid Wifi</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Toiletries Type</label>
                                                        <select class="select">
                                                            <option value="">Select Toiletries Type</option>
                                                            <option value="1">Free Toiletries</option>
                                                            <option value="2">Paid Toiletries</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-12 my-4">
                                                    <button type="submit" class="theme-btn">Submit Your Room</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#5831363e37183d20393528343d763b3735"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="2e474048416e4b564f435e424b004d4143">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
