...
<!-- Mirrored from live.themewild.com/tavelo/become-expert.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:35 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Become Expert</h2>
                ...
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Process</span>
                            <h2 class="site-title">Let's Check How It Works</h2>
                        </div>
                    </div>
                </div>
        ...
        <!-- video area -->
        <div class="video-area video-2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Video</span>
                            <h2 class="site-title">Share the Beauty of Your City</h2>
                        </div>
                    </div>
                </div>
                <div class="video-content rounded-pill" style="background-image: url(assets/img/video/01.jpg);">
                    <div class="row align-items-center">
                        <div class="col-lg-12">
        ...
        <div class="feature-area py-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Local Expert</span>
                            <h2 class="site-title">Why Be A Local Expert</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="feature-item">
                                ...
                                <div class="feature-content">
                                    <h4 class="feature-title">Award Winning Services</h4>
                                    <p>It is a long established fact that reader will of page when looking at its make a type specimen book
                                        layout.</p>
                                </div>
                            </div>
                ...
                <div class="cta-wrapper">
                    <div class="col-md-10 col-lg-8 col-xl-6 mx-auto">
                        <div class="cta-content">
                            ...
                            <a href="contact.html" class="theme-btn mt-20">Become Expert <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="cta-img">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#244d4a424b64415c45495448410a474b49"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="21484f474e614459404c514d440f424e4c">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
