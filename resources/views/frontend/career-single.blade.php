...
<!-- Mirrored from live.themewild.com/tavelo/career-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:34 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    ...
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#7f161119103f1a071e120f131a511c1012"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="452c2b232a05203d24283529206b262a28">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Career Single</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index-2.html">Home</a></li>
                    <li class="active">Career Single</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
        ...
        <!-- career-single -->
        <div class="career-single py-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="job-single-img">
                            <img src="assets/img/career/single.jpg" alt="">
                        </div>
                        <div class="job-details">
                            <div>
                                <h3 class="my-3">Senior Web Developer</h3>
                                <p>
                            ...
                            <div class="job-single-list mt-4">
                                <h4 class="my-3">Job Responsibilities</h4>
                                <ul>
                                    <li><i class="far fa-dot-circle"></i> At vero eos et accusamus et iusto odio
                                        dignissimos</li>
                                    <li><i class="far fa-dot-circle"></i> Accusamus et iusto odio dignissimos ducimus
                                        qui blanditiis praesentium voluptatum</li>
                                    <li><i class="far fa-dot-circle"></i> Deleniti atque corrupti quos dolores et quas
                                        molestias excepturi sint occaecati cupiditate</li>
                                    <li><i class="far fa-dot-circle"></i> Nam libero tempore, cum soluta nobis est
                                        eligendi optio cumque nihil impedit quo minus </li>
                                    <li><i class="far fa-dot-circle"></i> Quod maxime placeat facere possimus omnis
                                        voluptas assumenda est</li>
                                    <li><i class="far fa-dot-circle"></i> Temporibus autem quibusdam et aut officiis
                                        debitis aut rerum necessitatibus saepe</li>
                                    <li><i class="far fa-dot-circle"></i> Ut aut reiciendis voluptatibus maiores alias
                                        consequatur aut perferendis </li>
                                </ul>
                            </div>
                            <div class="job-single-list mt-4">
                                <h4 class="my-3">Job Requirements</h4>
                                <ul>
                                    <li><i class="far fa-dot-circle"></i> At vero eos et accusamus et iusto odio
                                        dignissimos</li>
                                    <li><i class="far fa-dot-circle"></i> Accusamus et iusto odio dignissimos ducimus
                            ...
                            <div class="job-single-list mt-4">
                                <h4 class="my-3">Skill & Experience</h4>
                                <ul>
                                    <li><i class="far fa-dot-circle"></i> At vero eos et accusamus et iusto odio
                                        dignissimos</li>
                                    <li><i class="far fa-dot-circle"></i> Accusamus et iusto odio dignissimos ducimus
                    ...
                    <div class="col-lg-4">
                        <div class="widget job-single-info">
                            <h4 class="widget-title">Job Overviews</h4>
                            ...
                            <a href="#" class="theme-btn mt-4"> Apply Now <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#1871767e77587d60797568747d367b7775"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="452c2b232a05203d24283529206b262a28">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/career-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:35 GMT -->
</html>