<html lang="en" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage no-websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths"><head><style>body {transition: opacity ease-in 0.2s; } 
...
<body>
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        <ul class="navbar-nav">
                            ...
                            <!-- <li class="nav-item dropdown">
                                <a class="nav-link " href="flight-list.html" data-bs-toggle="dropdown">Flight</a>
                                <ul class="dropdown-menu fade-down">
                            ...
                            <li class="nav-item"><a class="nav-link" href="flight-list.html">Flight</a></li>
                            <li class="nav-item"><a class="nav-link" href="hotel-grid.html">Hotel</a></li>
                            <li class="nav-item"><a class="nav-link" href="About.html">About Us</a></li>
                            <li class="nav-item"><a class="nav-link" href="activity-grid.html">Activity</a></li>
                            <!-- <li class="nav-item dropdown">
                                <a class="nav-link" href="hotel-grid.html" data-bs-toggle="dropdown">Hotel</a>
                                <ul class="dropdown-menu fade-down">
                            ...
                            <!-- <li class="nav-item ">
                                <a class="nav-link " href="about.html" data-bs-toggle="dropdown">About Us</a>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Activity Grid</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Activity Grid</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group-icon">
                                                    <input type="text" name="location" class="form-control" value="New York, United States">
                                            ...
                                            <div class="form-group">
                                                <div class="search-form-date">
                                                    <div class="search-form-journey">
                                                        ...
                                                        <div class="form-group-icon">
                                                            <input type="text" name="journey-date" class="form-control date-picker journey-date hasDatepicker" id="dp1771625258902">
                                                            <i class="fal fa-calendar-days"></i>
                                                        </div>
                                                        <p class="journey-day-name">Sunday</p>
                                                    </div>
                                                    <div class="search-form-return">
                                                        <label>Check Out</label>
                                                        <div class="form-group-icon">
                                                            <input type="text" name="return-date" class="form-control date-picker return-date hasDatepicker" id="dp1771625258903">
                                                        </div>
                                                        <p class="return-day-name">Monday</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <div class="dropdown-item">
                                                        <div class="passenger-item">
                                                            ...
                                                            <div class="passenger-qty">
                                                                <button type="button" class="minus-btn"><i class="far fa-minus"></i></button>
                                                                <input type="text" name="room" class="qty-amount passenger-room" value="2" readonly="">
                                                                <button type="button" class="plus-btn"><i class="far fa-plus"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="dropdown-item">
                                                        ...
                                                        <div class="passenger-class-info">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" value="Single Room" name="room-type" id="room-type4">
                                                                <label class="form-check-label" for="room-type4">
                                                                    Single Room
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" checked="" type="radio" value="Double Room" name="room-type" id="room-type5">
                                                                <label class="form-check-label" for="room-type5">
                                                                    Double Room
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" value="Deluxe Room" name="room-type" id="room-type6">
                    ...
                    <div class="col-lg-4 col-xl-3 mb-4">
                        <div class="booking-sidebar">
                            <div class="booking-item">
                                <h4 class="booking-title">Activity Type</h4>
                                <div class="activity-type">
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-type" type="checkbox" value="1" id="activity-type1">
                                        <label class="form-check-label" for="activity-type1">
                                            Food &amp; Nightlife <span>(20)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-type" type="checkbox" value="2" id="activity-type2">
                                        <label class="form-check-label" for="activity-type2">
                                            Hot Air Balloon <span>(15)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-type" type="checkbox" value="3" id="activity-type3">
                                        <label class="form-check-label" for="activity-type3">
                                            Mountain Climbing <span>(18)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-type" type="checkbox" value="4" id="activity-type4">
                                        <label class="form-check-label" for="activity-type4">
                                            Bike Ride <span>(35)</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="booking-item">
                                <h4 class="booking-title">Activity Price</h4>
                                <div class="activity-price">
                                    <div class="price-range-slider">
                                        ...
                                        <div id="price-range1" class="price-range slider ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"><div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 15%; width: 35%;"></div><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 15%;"></span><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 50%;"></span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="booking-item">
                                <h4 class="booking-title">Activity Duration</h4>
                                <div class="activity-duration">
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-duration" type="checkbox" value="1" id="activity-duration1">
                                        <label class="form-check-label" for="activity-duration1">
                                            Up to 1 hour <span>(20)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-duration" type="checkbox" value="2" id="activity-duration2">
                                        <label class="form-check-label" for="activity-duration2">
                                            1 to 4 hours <span>(15)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-duration" type="checkbox" value="3" id="activity-duration3">
                                        <label class="form-check-label" for="activity-duration3">
                                            4 hours to 1 day <span>(18)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-duration" type="checkbox" value="4" id="activity-duration4">
                            ...
                            <div class="booking-item">
                                ...
                                <div class="activity-language">
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-language" type="checkbox" value="1" id="activity-language1">
                                        <label class="form-check-label" for="activity-language1">
                                            English <span>(20)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-language" type="checkbox" value="2" id="activity-language2">
                                        <label class="form-check-label" for="activity-language2">
                                            Spanish <span>(15)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-language" type="checkbox" value="3" id="activity-language3">
                                        <label class="form-check-label" for="activity-language3">
                                            French <span>(18)</span>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="activity-language" type="checkbox" value="4" id="activity-language4">
                                        <label class="form-check-label" for="activity-language4">
                        ...
                        <div class="col-md-12">
                            <div class="booking-sort">
                                ...
                                <div class="col-md-3 booking-sort-box">
                                    ...
                                    </select><div class="nice-select select" tabindex="0"><span class="current">Sort By Default</span><ul class="list"><li data-value="1" class="option selected">Sort By Default</li><li data-value="2" class="option">Sort By Popular</li><li data-value="3" class="option">Sort By Low Price</li><li data-value="4" class="option">Sort By High Price</li></ul></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-lg-4">
                                <div class="activity-item">
                                    ...
                                    <div class="activity-content">
                                        <h4 class="activity-title"><a href="#">Snow Mountain Climbing</a></h4>
                                        ...
                                        <div class="activity-rate">
                                            ...
                                            <span class="activity-rate-review">(2.5k Reviews)</span>
                                        </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="activity-item">
                                    <div class="activity-img">
                                        <span class="badge">Featured</span>
                                        <img src="assets/img/activity/06.jpg" alt="">
                                        <a href="#" class="add-wishlist"><i class="far fa-heart"></i></a>
                                    </div>
                                    <div class="activity-content">
                                        <h4 class="activity-title"><a href="#">Snow Mountain Climbing</a></h4>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="activity-item">
                                    <div class="activity-img">
                                        ...
                                        <img src="assets/img/activity/07.jpg" alt="">
                                        <a href="#" class="add-wishlist"><i class="far fa-heart"></i></a>
                                    </div>
                                    <div class="activity-content">
                                        <h4 class="activity-title"><a href="#">Snow Mountain Climbing</a></h4>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="activity-item">
                                    <div class="activity-img">
                                        <img src="assets/img/activity/08.jpg" alt="">
                                        <a href="#" class="add-wishlist"><i class="far fa-heart"></i></a>
                                    </div>
                                    <div class="activity-content">
                                        <h4 class="activity-title"><a href="#">Snow Mountain Climbing</a></h4>
                            ...
                            <div class="pagination-area">
                                ...
                                <div class="pagination-showing"> 
                                    <p>Showing 1 - 6 of 24 Activities</p>
                                </div>
                            </div>
                            <!-- pagination end -->
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <p class="copyright-text">
                            © Copyright <span id="date">2026</span> <a href="#"> Tavelo </a> All Rights Reserved.
                        </p>
                    </div>
                    <div class="col-md-6 align-self-center">
    ...
    <script src="assets/js/main.js"></script><div id="ui-datepicker-div" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>
