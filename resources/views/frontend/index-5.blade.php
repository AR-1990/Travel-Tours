...
<!-- Mirrored from live.themewild.com/tavelo/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:00 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body class="home-4">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#fe97909891be9b869f938e929bd09d9193"><i
    ...
    <main class="main">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>It is a long established fact that reader will of page when looking at its make a
                                        type specimen book
                                        layout.</p>
                                </div>
                            </div>
        ...
        <!-- travel deal -->
        <div class="deal-area deal-1 py-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                ...
                <div class="row wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                    <div class="col-md-6 col-lg-3">
                        <div class="deal-item">
                            <div class="deal-info">
                                <h5 class="deal-title">New York</h5>
                                <span class="deal-price">$720.00</span>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="deal-item">
                            <div class="deal-info">
                                <h5 class="deal-title">Hong Kong</h5>
                                <span class="deal-price">$680.00</span>
                            </div>
                            <a href="#" class="theme-btn">Book Now<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="deal-item">
                            <div class="deal-info">
                                <h5 class="deal-title">San Francisco</h5>
                                <span class="deal-price">$450.00</span>
                            </div>
                            <a href="#" class="theme-btn">Book Now<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="deal-item">
                            <div class="deal-info">
                                <h5 class="deal-title">Las Vegas</h5>
                                <span class="deal-price">$620.00</span>
                            </div>
                            <a href="#" class="theme-btn">Book Now<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="deal-item">
                            <div class="deal-info">
                                <h5 class="deal-title">Los Angeles</h5>
                                <span class="deal-price">$560.00</span>
                            </div>
                            <a href="#" class="theme-btn">Book Now<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="deal-item">
                            <div class="deal-info">
                                <h5 class="deal-title">Sydney</h5>
                                <span class="deal-price">$340.00</span>
                            </div>
                            <a href="#" class="theme-btn">Book Now<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="deal-item">
                            <div class="deal-info">
                                <h5 class="deal-title">New Orleans</h5>
                                <span class="deal-price">$580.00</span>
                            </div>
                            <a href="#" class="theme-btn">Book Now<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="deal-item">
                            <div class="deal-info">
                                <h5 class="deal-title">Australia</h5>
                                <span class="deal-price">$950.00</span>
                            </div>
                            <a href="#" class="theme-btn">Book Now<i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                            ...
                            <div class="blog-item-info">
                                ...
                                <h4 class="blog-title">
                                    <a href="blog-single.html">There are many variations available For majority in some
                                        injected
                                        humour</a>
                                </h4>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".50s">
                            ...
                            <div class="blog-item-info">
                                ...
                                <h4 class="blog-title">
                                    <a href="blog-single.html">Established fact that reader distract will by the
                                        readable content</a>
                                </h4>
                                <a class="theme-btn mt-3" href="blog-single.html">Read More <i
                                        class="fas fa-arrow-circle-right"></i></a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".75s">
                            ...
                            <div class="blog-item-info">
                                ...
                                <h4 class="blog-title">
                                    <a href="blog-single.html">Contrary to popular belief simply text random roots piece
                                        of
                                        classical</a>
                                </h4>
                                <a class="theme-btn mt-3" href="blog-single.html">Read More <i
                ...
                <div class="cta-wrapper">
                    <div class="col-md-10 col-lg-8 col-xl-6 mx-auto">
                        <div class="cta-content">
                            ...
                            <a href="contact.html" class="theme-btn mt-20">Book Now <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="cta-img">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#c8a1a6aea788adb0a9a5b8a4ade6aba7a5"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="4f262129200f2a372e223f232a612c2022">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:01 GMT -->
</html>