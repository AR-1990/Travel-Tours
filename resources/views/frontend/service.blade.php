...
<!-- Mirrored from live.themewild.com/tavelo/service.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:47 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#d3babdb5bc93b6abb2bea3bfb6fdb0bcbe"><i
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="service-item wow fadeInUp" data-wow-duration="1s"
                        data-wow-delay=".25s">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        data-wow-delay=".50s">
                            <div class="service-icon">
                                <img src="assets/img/icon/tour.html" alt="">
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        data-wow-delay=".25s">
                            <div class="service-icon">
                                <img src="assets/img/icon/travel-business.html" alt="">
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        data-wow-delay=".50s">
                            <div class="service-icon">
                                <img src="assets/img/icon/hotel.html" alt="">
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        data-wow-delay=".75s">
                            <div class="service-icon">
                                <img src="assets/img/icon/guide.html" alt="">
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        data-wow-delay=".75s">
                            <div class="service-icon">
                                <img src="assets/img/icon/location.html" alt="">
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        data-wow-delay=".75s">
                            <div class="service-icon">
                                <img src="assets/img/icon/agent.html" alt="">
                            </div>
                            <div class="service-content">
                                <h3 class="service-title">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#4f262129200f2a372e223f232a612c2022"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="e38a8d858ca3869b828e938f86cd808c8e">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/service.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:52 GMT -->
</html>