...
<!-- Mirrored from live.themewild.com/tavelo/hotel-room-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:15 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#f0999e969fb09588919d809c95de939f9d"><i
    ...
    <main class="main">
        ...
        <!-- breadcrumb -->
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/04.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Room Grid</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index-2.html">Home</a></li>
                    <li class="active">Room Grid</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xl-3 mb-4">
                        <div class="booking-sidebar">
                                ...
                                <div class="facility">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="facility6">
                                            Luggage Storager <span>(18)</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="booking-item">
                                <h4 class="booking-title">Room Price</h4>
                            ...
                            <div class="booking-item">
                                <h4 class="booking-title">Room Type</h4>
                                <div class="room-type">
                                    <div class="form-check">
                                        <input class="form-check-input" name="room-type" type="checkbox" value="1"
                                            id="room-type1">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="room-type" type="checkbox" value="2"
                                            id="room-type2">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="room-type" type="checkbox" value="3"
                                            id="room-type3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="room-type" type="checkbox" value="4"
                                            id="room-type4">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="room-type" type="checkbox" value="5"
                                            id="room-type5">
                                        <label class="form-check-label" for="room-type5">
                                            Lake View <span>(27)</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="booking-sort">
                                ...
                                <div class="booking-sort-list-grid">
                                    <a class="booking-sort-grid active" href="hotel-room-grid.html"><i
                                            class="far fa-grid-2"></i></a>
                                    <a class="booking-sort-list" href="hotel-room-list.html"><i
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#30595e565f705548515d405c551e535f5d"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="325b5c545d72574a535f425e571c515d5f">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/hotel-room-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:19 GMT -->
</html>