...
<!-- Mirrored from live.themewild.com/tavelo/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:02 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body class="home-6">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#c4adaaa2ab84a1bca5a9b4a8a1eaa7aba9"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="553c3b333a15302d34382539307b363a38">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <main class="main">
        ...
        <div class="hero-section">
            <div class="hero-single" style="background: url(assets/img/hero/hero-8.jpg)">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-12 mx-auto">
                            <div class="hero-content text-center">
                                <div class="hero-content-wrapper">
                                    <h1 class="hero-title">Love Where You're Going</h1>
                                    <p>Book Experiences You'll Want To Tell The World About</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- activity area -->
        <div class="activity-area bg pt-80 pb-80">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Activity</span>
                            <h2 class="site-title">Our Most Popular Activities</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="activity-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="activity-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".50s">
                            <div class="activity-img">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="activity-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".75s">
                            <div class="activity-img">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="activity-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
                            <div class="activity-img">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                <div class="destination-more-info">
                                    ...
                                    <span><i class="far fa-person-hiking"></i> 35 Activity</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                ...
                                <span><i class="far fa-person-hiking"></i> 25 Activity</span>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                ...
                                <span><i class="far fa-person-hiking"></i> 28 Activity</span>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                ...
                                <span><i class="far fa-person-hiking"></i> 33 Activity</span>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#a9c0c7cfc6e9ccd1c8c4d9c5cc87cac6c4"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="c1a8afa7ae81a4b9a0acb1ada4efa2aeac">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:04 GMT -->
</html>