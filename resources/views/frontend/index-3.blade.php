...
<!-- Mirrored from live.themewild.com/tavelo/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:45:59 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body class="home-2">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#375e59515877524f565a475b521954585a"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="7b12151d143b1e031a160b171e55181416">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <main class="main">
        ...
        <div class="hero-section">
            <div class="container">
                <div class="hero-slider owl-carousel owl-theme">
                                ...
                                <div class="col-lg-12 mx-auto">
                                    <div class="hero-content text-center">
                                        <div class="hero-content-wrapper">
                                            <h1 class="hero-title" data-animation="fadeInUp" data-delay=".25s">Explore
                                                The
                                                World Together</h1>
                                            <p data-animation="fadeInUp" data-delay=".50s">Find awesome flight, hotel,
                                                tour,
                                                car and packages</p>
                                        </div>
                                    </div>
                    ...
                    <div class="hero-single" style="background: url(assets/img/hero/hero-5.jpg)">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-12 mx-auto">
                                    <div class="hero-content text-center">
        ...
        <!-- destination area -->
        <div class="destination-area pt-80 pb-80">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#e28b8c848da2879a838f928e87cc818d8f"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="f29b9c949db2978a939f829e97dc919d9f">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:00 GMT -->
</html>