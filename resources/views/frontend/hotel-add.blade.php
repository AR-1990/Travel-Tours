...
<!-- Mirrored from live.themewild.com/tavelo/hotel-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:24 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
    ...
    <!-- title -->
    <title>Tavelo - Travel Booking HTML5 Template</title>
...
<body>
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#d6bfb8b0b996b3aeb7bba6bab3f8b5b9bb"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="1a73747c755a7f627b776a767f34797577">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="header-account">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item" href="profile-booking.html"><i class="far fa-shopping-bag"></i> My Booking</a></li>
                                    <li><a class="dropdown-item" href="profile-booking-history.html"><i class="far fa-clipboard-list"></i> Booking History</a></li>
                                    <li><a class="dropdown-item" href="profile-wishlist.html"><i class="far fa-heart"></i> My Wishlist</a></li>
                                    <li><a class="dropdown-item" href="profile-wallet.html"><i class="far fa-wallet"></i> My Wallet</a></li>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Add Hotel</h2>
                    ...
                    <div class="col-lg-3">
                        <div class="user-profile-sidebar">
                            <div class="user-profile-sidebar-top">
                                ...
                                <h4>Antoni Jonson</h4>
                                <p><a href="https://live.themewild.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="84eeebeaf7ebeac4e1fce5e9f4e8e1aae7ebe9">info@wisetrust.com</a></p>
                            </div>
                            <ul class="user-profile-sidebar-list">
                                ...
                                <li class="profile-menu">
                                    <a class="active" href="#profile-menu" data-bs-toggle="collapse" aria-expanded="false" aria-controls="profile-menu">
                    ...
                    <div class="col-lg-9">
                        <div class="user-profile-wrapper">
                            <div class="user-profile-card add-listing">
                                <h4 class="user-profile-card-title">Add Hotel</h4>
                                <div class="col-lg-12">
                                    <div class="add-listing-form">
                                        ...
                                        <form action="#">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Total Number Of Rooms & Suites</label>
                                                ...
                                                <h5 class="my-4">Your Hotel Information</h5>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <label>Minimum Stay</label>
                                                        <select class="select">
                                                            <option value="">Select Minimum Stay</option>
                                                            <option value="1">2 Nights Or Less</option>
                                                            <option value="2">More Than 2 Nights</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select">
                                                            <option value="">Select On Site Staff</option>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select">
                                                            ...
                                                            <option value="1">Included In Room Rate</option>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select">
                                                            ...
                                                            <option value="1">24 Hour Staffing</option>
                                                            <option value="2">Limited Hours Staffing</option>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select">
                                                            ...
                                                            <option value="1">All En Suite</option>
                                                            <option value="2">Some En Suite</option>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="listing-upload-wrapper">
                                                            <div class="listing-img-upload">
                                                                <span><i class="far fa-images"></i> Upload listing Images</span>
                                                            </div>
                                                            <input type="file" class="listing-img-file" multiple>
                                                        </div>
                                                    </div>
                                                </div>
                                                <h5 class="my-4">Detailed Information</h5>
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                ...
                                                <h5 class="my-4">Amenities</h5>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity1">
                                                        <label class="form-check-label" for="aminity1">
                                                ...
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity2">
                                                        <label class="form-check-label" for="aminity2">
                                                            Bar / Lounge
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity3">
                                                        <label class="form-check-label" for="aminity3">
                                                            Beach
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity4">
                                                        <label class="form-check-label" for="aminity4">
                                                            Beverage Selection
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity5">
                                                        <label class="form-check-label" for="aminity5">
                                                            Swimming Pool
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity6">
                                                        <label class="form-check-label" for="aminity6">
                                                            WiFi
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity7">
                                                        <label class="form-check-label" for="aminity7">
                                                            Coffee
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity8">
                                                        <label class="form-check-label" for="aminity8">
                                                            Air Conditioning
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity9">
                                                        <label class="form-check-label" for="aminity9">
                                                            Entertainment
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity10">
                                                        <label class="form-check-label" for="aminity10">
                                                ...
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity11">
                                                        <label class="form-check-label" for="aminity11">
                                                            Wheelchair Access
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity12">
                                                        <label class="form-check-label" for="aminity12">
                                                            Fitness Facility
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity13">
                                                        <label class="form-check-label" for="aminity13">
                                                            Breakfast
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity14">
                                                        <label class="form-check-label" for="aminity14">
                                                            Handicap Accessible
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity15">
                                                        <label class="form-check-label" for="aminity15">
                                                            Pets Allowed
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity16">
                                                        <label class="form-check-label" for="aminity16">
                                                            Suitable For Events
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity17">
                                                        <label class="form-check-label" for="aminity17">
                                                            Restaurant
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity18">
                                                        <label class="form-check-label" for="aminity18">
                                                            Doorman
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity19">
                                                        <label class="form-check-label" for="aminity19">
                                                            Free Parking
                                                        </label>
                                                      </div>
                                                </div>
                                                <div class="col-6 col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="aminity" type="checkbox" value="" id="aminity20">
                                                        <label class="form-check-label" for="aminity20">
                                                            Wine Bar
                                                        </label>
                                                      </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12 my-4">
                                                    <button type="submit" class="theme-btn">Submit Your Hotel</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#8be2e5ede4cbeef3eae6fbe7eea5e8e4e6"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="bdd4d3dbd2fdd8c5dcd0cdd1d893ded2d0">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
