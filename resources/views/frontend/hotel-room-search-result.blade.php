...
<!-- Mirrored from live.themewild.com/tavelo/hotel-room-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:21 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#caa3a4aca58aafb2aba7baa6afe4a9a5a7"><i
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/04.jpg)">
            <div class="container">
                ...
                <ul class="breadcrumb-menu">
                    ...
                    <li class="active">Room Search</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#2b42454d446b4e534a465b474e05484446"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="9ff6f1f9f0dffae7fef2eff3fab1fcf0f2">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
