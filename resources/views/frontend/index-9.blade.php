...
<!-- Mirrored from live.themewild.com/tavelo/index-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:05 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body class="home-8">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#1d74737b725d78657c706d7178337e7270"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="523b3c343d12372a333f223e377c313d3f">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <main class="main">
        ...
        <div class="hero-section">
            <div class="hero-single" style="background: url(assets/img/hero/hero-10.jpg)">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-12 mx-auto">
                            <div class="hero-content text-center">
                                <div class="hero-content-wrapper">
                                    <h1 class="hero-title">Book Cruise Make Holidays Easy</h1>
                                    <p>Find Great Cruise Deals For Your Next Holidays Trip And Enjoy</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="feature-area pb-120">
            <div class="container">
                <div class="feature-wrapper">
                    <div class="row g-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
        ...
        <!-- cruise area -->
        <div class="cruise-area bg pt-80 pb-80">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Cruise</span>
                            <h2 class="site-title">Our Most Popular Cruises</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="cruise-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="cruise-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".50s">
                            <div class="cruise-img">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="cruise-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".75s">
                            <div class="cruise-img">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="cruise-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">
                            <div class="cruise-img">
        ...
        <!-- travel deal -->
        <div class="deal-area deal-2 pb-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Travel Deal</span>
                            <h2 class="site-title">Our Most Popular Travel Deals</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="deal-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                            <div class="deal-img">
                                <img src="assets/img/deal/01.jpg" alt="">
                            </div>
                            <div class="deal-info">
                                <h5 class="deal-title"><a href="#">Explore The Beauty Of Sea</a></h5>
                                <span class="deal-price">From <span>$720.00</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="deal-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".50s">
                            <div class="deal-img">
                                <img src="assets/img/deal/02.jpg" alt="">
                            </div>
                            <div class="deal-info">
                                <h5 class="deal-title"><a href="#">Explore The Beauty Of Sea</a></h5>
                                <span class="deal-price">From <span>$680.00</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="deal-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".75s">
                            <div class="deal-img">
                                <img src="assets/img/deal/03.jpg" alt="">
                            </div>
                            <div class="deal-info">
                                <h5 class="deal-title"><a href="#">Explore The Beauty Of Sea</a></h5>
                                <span class="deal-price">From <span>$450.00</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="deal-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                            <div class="deal-img">
                                <img src="assets/img/deal/04.jpg" alt="">
                            </div>
                            <div class="deal-info">
                                <h5 class="deal-title"><a href="#">Explore The Beauty Of Sea</a></h5>
                                <span class="deal-price">From <span>$620.00</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="deal-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".50s">
                            <div class="deal-img">
                                <img src="assets/img/deal/05.jpg" alt="">
                            </div>
                            <div class="deal-info">
                                <h5 class="deal-title"><a href="#">Explore The Beauty Of Sea</a></h5>
                                <span class="deal-price">From <span>$560.00</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="deal-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".75s">
                            <div class="deal-img">
                                <img src="assets/img/deal/06.jpg" alt="">
                            </div>
                            <div class="deal-info">
                                <h5 class="deal-title"><a href="#">Explore The Beauty Of Sea</a></h5>
                                <span class="deal-price">From <span>$340.00</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                <div class="destination-more-info">
                                    ...
                                    <span><i class="far fa-ship"></i> 35 Cruise</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                ...
                                <span><i class="far fa-ship"></i> 25 Cruise</span>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                ...
                                <span><i class="far fa-ship"></i> 28 Cruise</span>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                        ...
                        <div class="destination-info">
                            ...
                            <div class="destination-more-info">
                                ...
                                <span><i class="far fa-ship"></i> 33 Cruise</span>
                            </div>
                        </div>
                    </div>
                    <div class="destination-item">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#3a53545c557a5f425b574a565f14595557"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="fc95929a93bc99849d918c9099d29f9391">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/index-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:08 GMT -->
</html>