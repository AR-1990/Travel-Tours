...
<!-- Mirrored from live.themewild.com/tavelo/hotel-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:15 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#95fcfbf3fad5f0edf4f8e5f9f0bbf6faf8"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="f891969e97b89d80999588949dd69b9795">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/05.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Hotel List</h2>
                        ...
                        <div class="col-md-12">
                            <div class="booking-sort">
                                ...
                                <div class="booking-sort-list-grid">
                                    <a class="booking-sort-grid" href="hotel-grid.html"><i
                                            class="far fa-grid-2"></i></a>
                                    <a class="booking-sort-list active" href="hotel-list.html"><i
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#c9a0a7afa689acb1a8a4b9a5ace7aaa6a4"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="1871767e77587d60797568747d367b7775">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
