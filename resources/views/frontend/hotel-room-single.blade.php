...
<!-- Mirrored from live.themewild.com/tavelo/hotel-room-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:19 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/05.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Room Single</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index-2.html">Home</a></li>
                    <li class="active">Room Single</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                        ...
                        <div class="col-lg-8">
                            <div class="listing-content">
                                <div class="listing-slider owl-carousel owl-theme">
                                    <img src="assets/img/hotel/room/single-1.jpg" alt="">
                                    <img src="assets/img/hotel/room/single-2.jpg" alt="">
                                    <img src="assets/img/hotel/room/single-3.jpg" alt="">
                                </div>
                                <div class="listing-header">
                                    <div class="listing-header-info">
                                        <h4 class="listing-title">Deluxe King Bed Private</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <ul class="list">
                                                    ...
                                                    <li>Check-in time is 2 PM - 4 PM and check-out by 10 AM.</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Wake-Up Call</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Own Parking Space</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Laundry</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Fitness Center</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Car Hire</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Sightseeing</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Massage</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Fruit Basket</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Conference Rooms</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-check"></i> Bicycle Hire</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing-item">
                                    ...
                                    <div class="listing-amenity">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-loveseat"></i> 2 Seater Sofa</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-wifi"></i> Free WiFi</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-water-ladder"></i> Private Pool</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-phone"></i> Direct Dial Phone</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-crosshairs"></i> Hair Dryer</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-bath"></i> Bathtub</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-dollar-sign"></i> Safe Deposit Box</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-bed"></i> Room Service</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="booking-sidebar listing-side-content mt-4">
                                ...
                                <ul class="listing-side-list">
                                    ...
                                    <li><i class="far fa-envelope"></i><a href="https://live.themewild.com/cdn-cgi/l/email-protection#630a0d050c23061b020e130f064d000c0e"><span class="__cf_email__" data-cfemail="f39a9d959cb3968b929e839f96dd909c9e">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                            <div class="booking-sidebar listing-side-content mt-4">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#9bf2f5fdf4dbfee3faf6ebf7feb5f8f4f6"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="e58c8b838aa5809d8488958980cb868a88">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/hotel-room-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:21 GMT -->
</html>