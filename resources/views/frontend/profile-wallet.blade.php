...
<!-- Mirrored from live.themewild.com/tavelo/profile-wallet.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:45 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">My Wallet</h2>
                    ...
                    <div class="col-lg-3">
                        <div class="user-profile-sidebar">
                            ...
                            <ul class="user-profile-sidebar-list">
                                ...
                                <li><a class="active" href="profile-wallet.html"><i class="far fa-wallet"></i> My Wallet</a></li>
