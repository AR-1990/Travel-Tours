...
<!-- Mirrored from live.themewild.com/tavelo/career.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:26 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    <li><a href="tel:+21234567897"><i class="far fa-phone-arrow-down-left"></i>+2 123
                                            4567 897</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#7f161119103f1a071e120f131a511c1012"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="3b52555d547b5e435a564b575e15585456">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <main class="main">
        ...
        <!-- our mission -->
        <div class="our-mission py-120 mb-30">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="mission-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".25s">
                            <div class="mission-img">
                                <img class="mission-img-1" src="assets/img/mission/01.jpg" alt="">
                                <img class="mission-img-2" src="assets/img/mission/02.jpg" alt="">
                            </div>
                            <div class="mission-shape">
                                <img src="assets/img/shape/07.svg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mission-right wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                            <div class="site-heading mb-3">
                                <span class="site-title-tagline"><i class="far fa-plane"></i> Our Mission</span>
                                <h2 class="site-title">We're Truely Dedicated To Make Travel Experience Simple!</h2>
                            </div>
                            <p>
                ...
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Gallery</span>
                            <h2 class="site-title">Inside Our Awesome Team</h2>
                        </div>
                    </div>
                </div>
                <div class="row popup-gallery g-4">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <a class="popup-img gallery-link" href="assets/img/gallery/08.jpg"><i
                                        class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <a class="popup-img gallery-link" href="assets/img/gallery/09.jpg"><i
                                        class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <a class="popup-img gallery-link" href="assets/img/gallery/10.jpg"><i
                                        class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <a class="popup-img gallery-link" href="assets/img/gallery/11.jpg"><i
                                        class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <a class="popup-img gallery-link" href="assets/img/gallery/12.jpg"><i
                                        class="far fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- career-area -->
        <div class="career-area pb-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Our Jobs</span>
                            <h2 class="site-title">Our Available Jobs</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-4">
                    <div class="col-md-12 col-lg-4">
                        <div class="career-item">
                            <div class="job-meta">
                                <span class="job-time"><i class="far fa-briefcase"></i><strong>Remote - Full
                                        Time</strong></span>
                            ...
                            <div class="job-content">
                                ...
                                <ul class="job-info-list">
                                    <li><span class="far fa-building"></span>MyTrip</li>
                                    <li><span class="far fa-map-marker-alt"></span>New York, USA</li>
                                    <li><span class="far fa-wallet"></span>$25k - $55k</li>
                                </ul>
                                <a href="#" class="job-btn">Apply Now <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-4">
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="career-item">
                            ...
                            <div class="job-content">
                                <h3>Claims and Safety Specialist</h3>
                                <ul class="job-info-list">
                                    <li><span class="far fa-building"></span>MyTrip</li>
                                    <li><span class="far fa-map-marker-alt"></span>New York, USA</li>
                                    <li><span class="far fa-wallet"></span>$25k - $55k</li>
        ...
        <!-- career-promo -->
        <div class="career-promo pb-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
                        <div class="site-heading text-center">
                            <span class="site-title-tagline"><i class="far fa-plane"></i> Join Us</span>
                            <h2 class="site-title">Why You Join With Us</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-4">
                    <div class="col-md-12 col-lg-4">
                        <div class="career-promo-single">
                            <span class="fal fa-home"></span>
                            <div class="career-promo-info">
                                <h4>Remote Working Facilities</h4>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="career-promo-single">
                            <span class="fal fa-briefcase-medical"></span>
                            <div class="career-promo-info">
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="career-promo-single">
                            ...
                            <div class="career-promo-info">
                                <h4>Annual Travel And Experiences</h4>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page when looking at its layout. </p>
                            </div>
                        </div>
                ...
                <div class="cta-wrapper">
                    <div class="col-md-10 col-lg-8 col-xl-6 mx-auto">
                        <div class="cta-content">
                            <div class="cta-text">
                                <h1>Join With Our Awesome Team!</h1>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content web page editors now use of a page when looking at its layout.</p>
                            </div>
                            <a href="contact.html" class="theme-btn mt-20">Apply Now <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="cta-img">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#4c25222a230c29342d213c2029622f2321"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="0b62656d644b6e736a667b676e25686466">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/career.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:34 GMT -->
</html>