...
<!-- Mirrored from live.themewild.com/tavelo/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:35 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    ...
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#acc5c2cac3ecc9d4cdc1dcc0c982cfc3c1"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="83eaede5ecc3e6fbe2eef3efe6ade0ecee">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="cart-product">
                                            ...
                                            <div class="cart-product-content">
                                               <a href="#" class="cart-product-title">Premium Lake View Room</a>
                                               <div class="cart-product-info">
                                                    <div class="cart-product-reservation">
                                                        <span><span>Reservation:</span> Oct 12, 2025 - Oct 20, 2025 (8 night)</span>
                                                    </div>
                                                    <div class="cart-product-geust">
                                                        <span><span>Guests:</span> 2 Adults</span>
                                                    </div>
                                                    <div class="cart-product-extra">
                                                        <span><span>Extra Services:</span> Cleaning, Airport Pickup, Breakfast, Parking</span>
                                                    </div>
                                               </div>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="cart-qty passenger-qty">
                                            <button class="minus-btn"><i class="far fa-minus"></i></button>
                                            <input class="qty-amount" type="text" value="1" disabled="">
                                            <button class="plus-btn"><i class="far fa-plus"></i></button>
                                        </div>
                                    </td>
                                    <td>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="cart-coupon">
                                    ...
                                    <button class="coupon-btn" type="submit">Apply Code</button>
                                </div>
                            </div>
                            <div class="col-lg-3 offset-lg-5">
                                <div class="cart-summary">
                                    ...
                                    <div class="text-end mt-40">
                                        <a href="#" class="theme-btn">Proceed To Checkout <i
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#11787f777e517469707c617d743f727e7c"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="cea7a0a8a18eabb6afa3bea2abe0ada1a3">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
...
<!-- Mirrored from live.themewild.com/tavelo/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:37 GMT -->
</html>