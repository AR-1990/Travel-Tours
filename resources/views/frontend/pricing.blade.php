...
<!-- Mirrored from live.themewild.com/tavelo/pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Feb 2026 21:46:47 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
                            ...
                            <div class="top-contact-info">
                                <ul>
                                    ...
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#97fef9f1f8d7f2eff6fae7fbf2b9f4f8fa"><i
                                                class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="b5dcdbd3daf5d0cdd4d8c5d9d09bd6dad8">info@wisetrust.com</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="pricing-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".25s">
                            <div class="pricing-header">
                                <div class="pricing-content">
                                    <h4>Basic</h4>
                                    <h1 class="pricing-amount">$220.59</h1>
                            ...
                            <div class="pricing-feature">
                                <ul>
                                    ...
                                    <li>1 Person Allowed</li>
                                    <li>Accomdation 1 Person</li>
                                    <li>Healthy Food & Snacks</li>
                                    <li>Tour Guide & Advisor</li>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="pricing-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".50s">
                            <div class="pricing-header">
                                <div class="pricing-content">
                                    <h4>Standard</h4>
                                    <h1 class="pricing-amount">$300.89</h1>
                                    <p>One Time Payment</p>
                                </div>
                            </div>
                            <div class="pricing-feature">
                                <ul>
                                    <li>30 Days Duration</li>
                                    <li>15 Person Allowed</li>
                                    <li>Accomdation 15 Person</li>
                                    <li>Healthy Food & Snacks</li>
                                    <li>Tour Guide & Advisor</li>
                                    <li>Flight Tickets</li>
                                </ul>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="pricing-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".75s">
                            <div class="pricing-header">
                                <div class="pricing-content">
                                    <h4>Premium</h4>
                                    <h1 class="pricing-amount">$500.69</h1>
                                    <p>One Time Payment</p>
                                </div>
                            </div>
                            <div class="pricing-feature">
                                <ul>
                                    <li>30 Days Duration</li>
                                    <li>30 Person Allowed</li>
                                    <li>Accomdation 30 Person</li>
                                    <li>Healthy Food & Snacks</li>
                                    <li>Tour Guide & Advisor</li>
                                    <li>Flight Tickets</li>
                                </ul>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="pricing-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".75s">
                            <div class="pricing-header">
                                <div class="pricing-content">
                                    <h4>VIP</h4>
                                    <h1 class="pricing-amount">$800.25</h1>
                                    <p>One Time Payment</p>
                                </div>
                            </div>
                            <div class="pricing-feature">
                                <ul>
                                    <li>30 Days Duration</li>
                                    <li>50 Person Allowed</li>
                                    <li>Accomdation 50 Person</li>
                                    <li>Healthy Food & Snacks</li>
                                    <li>Tour Guide & Advisor</li>
                                    <li>Flight Tickets</li>
                                </ul>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#a8c1c6cec7e8cdd0c9c5d8c4cd86cbc7c5"><i
                                            class="far fa-envelopes"></i><span class="__cf_email__" data-cfemail="f1989f979eb19489909c819d94df929e9c">info@wisetrust.com</span></a></li>
                            </ul>
                        </div>
                    </div>
