                ...
                <div class="profile_dropdown">
                    <div class="dropdown">
                        <a href="#" class="d-flex align-items-center text-light text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->first_name . ' ' . Auth::user()->last_name) }}&background=053750&color=fff" alt="">
    ...
    <div class="admin-panel d-flex">
        <aside id="dashboardSidebar" class="sidebar admin-sidebar position-fixed">
            <ul class="sidebar-menu list-unstyled mb-0">
                ...
                <li>
                    <a href="{{ route($isSuperAdmin ? 'admin.hotels.search' : $panelPrefix . '.hotels.search') }}" class="{{ (request()->routeIs('admin.hotels*') || request()->routeIs('agent.hotels*') || request()->routeIs('subagent.hotels*')) && ! request()->routeIs('*.hotels.reservations*') ? 'active' : '' }}">
