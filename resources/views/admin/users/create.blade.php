...
<div class="container-fluid panel-page">
    @include('admin.partials.page-header', [
        'title' => 'Create user',
        'subtitle' => 'First and last name are display only. User signs in with email or username.',
        'icon' => 'fas fa-user-plus',
        'actions' => '<a href="'.e(route('admin.users')).'" class="btn btn-light btn-sm"><i class="fas fa-arrow-left me-1"></i> Back</a>',
    ])
